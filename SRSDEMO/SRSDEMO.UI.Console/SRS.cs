...
namespace SRSDEMO.UI
{
    class SRS
    {
        ...
        static void Main(string[] args)
        {
            ...
            //修改学生的第一学期的成绩，变为不及格，尝试申请有先修课程的第二学期课程


            //尝试为成功修完第一学期课程的学生选修第二学期的课程

            Console.WriteLine("Student " + s1.Name + " is attempting to enroll in " + sec1.ToString());

            EnrollFlags status2 = sec1.Enroll(s1);

            ReportStatus(status2);

            Console.WriteLine("Student " + s1.Name +" is attempting to enroll in " +
            ...
            Console.WriteLine("Student " + s2.Name + " is attempting to enroll in " + se7.ToString());
